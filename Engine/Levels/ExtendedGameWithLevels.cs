...
namespace Pharaoh
{
    ...
    {
        public static string StateNameTitle = "title";
        public static string StateNameHelp = "help";
        public static string StateNameLevelSelect = "levelselect";
        public static string StateNamePlaying = "playing";
        public static string StateNameOptions = "options";
        ...
        protected void LoadProgress()
        {
            ...
            using (StreamReader r = new StreamReader("Content/Levels/levels_status.txt"))
            {
        ...
        private static void SaveProgress()
        {
            ...
            using (StreamWriter w = new StreamWriter("Content/Levels/levels_status.txt"))
            {
        ...
        public static void GoToNextLevel(int levelIndex)
        {
            ...
            if (levelIndex == NumberOfLevels)
                GameStateManager.SwitchTo(StateNameLevelSelect);
        ...
        {
            return (IPlayingState)GameStateManager.GetGameState(StateNamePlaying);
        }
    }
}