...
namespace Pharaoh.uitzoeken
{
    public class Camera
    {
        ...
        public void CenterOn(Cell cell)   // cell is a position in the grid, a tile class where this van be added?
        {
        ...
        {
            var cameraPosition = new Vector2(cell.X * Global.SpriteWidth, // the global is the main class. the sprite is the tile used
